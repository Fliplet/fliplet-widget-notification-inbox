...
this["Fliplet"]["Widget"]["Templates"]["templates.loadMore"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    ...
    + container.escapeExpression((helpers.T || (depth0 && depth0.T) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"widgets.notificationInbox.dataSource.loadMore",{"name":"T","hash":{},"data":data}))
...
this["Fliplet"]["Widget"]["Templates"]["templates.noNotifications"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"no-notifications\">\r\n  <h3>"
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.notificationInbox.dataSource.noNotification.title",{"name":"T","hash":{},"data":data}))
    + "</h3>\r\n  <p>"
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.notificationInbox.dataSource.noNotification.instruction",{"name":"T","hash":{},"data":data}))
    + "</p>\r\n</div>";
},"useData":true});
...
this["Fliplet"]["Widget"]["Templates"]["templates.notificationsError"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    ...
    + container.escapeExpression((helpers.T || (depth0 && depth0.T) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"widgets.notificationInbox.dataSource.notificationError",{"name":"T","hash":{},"data":data}))
    + "</h3>\r\n</div>";
},"useData":true});
...
this["Fliplet"]["Widget"]["Templates"]["templates.toolbar"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<p><span class=\"unread-count\">{{count}}</span> "
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.notificationInbox.dataSource.toolbar.unread",{"name":"T","hash":{},"data":data}))
    + " <span class=\"toolbar-read-all\">(<a data-read-all href=\"#\">"
    + alias3((helpers.T || (depth0 && depth0.T) || alias2).call(alias1,"widgets.notificationInbox.dataSource.toolbar.action",{"name":"T","hash":{},"data":data}))
